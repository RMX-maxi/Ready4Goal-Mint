...
<head>
  ...
  <style>
    ...
    .login-box { background:#fff; padding:2rem; border-radius:10px; box-shadow:0 2px 8px rgba(0,0,0,0.2); width:300px; text-align:center; }
    ...
    .register-link { margin-top:15px; display:block; color:#0099cc; text-decoration:none; }
...
<body>
  <div class="login-box">
    <h2>Coach Login</h2>
    <form method="POST" action="coach_login_process.php">
      <label>Email:</label>
    ...
    <a class="register-link" href="coach_register.php">Don't have an account? Register here</a>
