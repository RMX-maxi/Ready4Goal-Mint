...
<head>
  ...
  <style>
    ...
    .register-link a { color:#0099cc; text-decoration:none; }
...
<body>
  <div class="login-box">
    <h2>Academy Login</h2>
    <form method="POST" action="academy_login.php">
      <label>Email:</label>
    ...
    <div class="register-link">
      Don't have an account? <a href="academy_register.php">Register here</a>
    </div>
  </div>
</body>
</html>
